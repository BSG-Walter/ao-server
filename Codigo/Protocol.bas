...
Private auxiliarBuffer  As clsAuroraWriter
...
Public Sub InitAuxiliarBuffer()
    ...
    '***************************************************
    Set auxiliarBuffer = New clsAuroraWriter
...
Public Function HandleIncomingData(ByVal UserIndex As Integer, data As Network.Reader) As Boolean
    ...
    With UserList(UserIndex)
        ...
        'le asignamos el reader que acaba de llegar al incomingdata del usuario
        Call .incomingData.NewReader(data)
...
'***************************************************
    ...
    Dim buffer As clsAuroraReader
    Set buffer = New clsAuroraReader
...
Private Sub HandleCentinelReport(ByVal UserIndex As Integer)
    ...
    Dim NotBuff As New clsAuroraReader
...
Private Sub HandleDumpIPTables(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        Call WriteConsoleMsg(UserIndex, "Esta funcion esta en desuso", FontTypeNames.FONTTYPE_INFO)
...
Public Sub FlushBuffer(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        Call modNetwork.Send(UserIndex, .outgoingData.Writer)
...
Public Sub HandleSearchNpc(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        Dim buffer As New clsAuroraReader
...
On Error GoTo errHandler
    ...
    With UserList(UserIndex)
        'This packet contains strings, make a copy of the data to prevent losses if it's not complete yet...
        Dim buffer As clsAuroraReader: Set buffer = New clsAuroraReader
        Call buffer.CopyBuffer(.incomingData)
